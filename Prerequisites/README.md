...
### 1.1 Create a M365 Account

### 1.2 Create an Azure account and add Microsoft Entra ID Premium P2 trial licenses

The tasks in this exercise require and Azure subscription. You can use or  sign up for an Azure trial account. If you already have your own Azure subscription, you can skip this task.
...
5. You'll need a Microsoft Entra ID P2 license. In the organization you created, search for and then select Microsoft Entra ID.
